...
reg_t mtimer_base;
reg_t print_base;
reg_t exit_addr; /* TODO: get exit_addr from elf */
...
static void help(int exit_code = 1)
{
  ...
  fprintf(stderr, "  --syn_exit            SCR program exit address\n");
...
/*    printf("%lx\n", base);*/
  ...
  parser.option(0, "syn_exit", 1, [&](const char* s){exit_addr = strtoull(s, 0, 0);});
