...
//#define CSR_MMUTLBATTR 0xbc0
//#define CSR_MMUTLBVA 0xbc1
//#define CSR_MMUTLBUPDATE 0xbc2
//#define CSR_MMUTLBSCAN 0xbc3
...
#endif
#ifdef DECLARE_CSR
DECLARE_CSR(mmutlbattr, CSR_MMUTLBATTR)
DECLARE_CSR(mmutlbvaddr, CSR_MMUTLBVA)
DECLARE_CSR(mmutlbupd, CSR_MMUTLBUPDATE)
DECLARE_CSR(mmutlbscan, CSR_MMUTLBSCAN)
