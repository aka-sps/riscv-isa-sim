...
// SCR defines
DECLARE_CSR(scr_csr_mpu_sel, SCR_CSR_MPU_SEL)
DECLARE_CSR(scr_csr_mpu_ctrl, SCR_CSR_MPU_CTRL)
DECLARE_CSR(scr_csr_mpu_addr, SCR_CSR_MPU_ADDR)
DECLARE_CSR(scr_csr_mpu_mask, SCR_CSR_MPU_MASK)
