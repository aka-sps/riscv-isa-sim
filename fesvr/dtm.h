...
class dtm_t : public htif_t
{
 ...
 protected:
  virtual void read_chunk(addr_type taddr, size_t len, void* dst) override;
  virtual void write_chunk(addr_type taddr, size_t len, const void* src) override;
  virtual void clear_chunk(addr_type taddr, size_t len) override;
